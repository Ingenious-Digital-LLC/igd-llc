            ...
            {[...Array(3)].map((_, i) => (
              <div
                ...
                style={{
                  ...
                  animation: `slideIn${i % 2 === 0 ? "Left" : "Right"} 3s ${
                    i * 0.2
                  }s infinite`,
                }}
              />
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-red-500 to-red-600 rounded-xl transform group-hover:scale-105 transition-all duration-300 shadow-lg group-hover:shadow-red-500/25">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            <img
              src={iconLogo}
              alt="logo"
              className="w-10 h-10 object-cover text-white drop-shadow-lg transform group-hover:scale-110 transition-transform duration-300"
            />
          </div>
        </div>
